/*! Auxin WordPress Framework - v2.5.4 (2020-03-17)
        ...
        function initAjaxSearch( element ) {
            ...
            $field.on( 'keyup' , function( event ) {
                ...
                delay = setTimeout( function(){
                    ...
                    ajaxSearchRequest( searchKey, { id: catID, taxonomy: taxonomy } , $ajaxOutput, $spinner );
                }, 700);
            ...
            if ( $cats.length ) {
                $cats.on( 'change', function(event) {
                    var selectedTax = $(event.target).find('option:selected').data('taxonomy');
                    
                    catID    = event.target.value;
                    taxonomy = selectedTax;

                    ajaxSearchRequest( $field.val(), { id: catID, taxonomy: taxonomy }, $ajaxOutput, $spinner );
                });
            }
