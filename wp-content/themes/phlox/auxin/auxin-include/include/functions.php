...
if( ! function_exists( 'auxin_the_breadcrumbs' ) ){
    ...
    function auxin_the_breadcrumbs( $icon = '' ) {
        $breadcrumb = new Auxin_Breadcrumb();
        $breadcrumb->set_separator_icon( $icon );
        $breadcrumb->render();
    }
...
function auxin_get_available_post_types_for_search() {
    ...
    if ( class_exists('WooCommerce') ) {
        $post_types['product'] = __( 'Product', 'phlox' );
    }

    if ( class_exists('AUXPFO') ) {
        $post_types['portfolio'] = __( 'Portfolio', 'phlox' );
    }

    if ( class_exists('AUXNEW') ) {
        $post_types['news'] = __( 'News', 'phlox' );
    }

    if ( class_exists( 'AUXPRO' )) {
        $post_types['faq'] = __( 'FAQ', 'phlox' );
    }
