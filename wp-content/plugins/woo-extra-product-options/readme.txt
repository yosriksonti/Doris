...
= 3.0.7 =
* Improvement: Improved the min, max length validation messages.
* Improvement: Added compatibility with Loco Translate plugin.
* Improvement: Added WooCommerce version - 5.5.2 compatibility.
* Improvement: Added WordPress 5.8 compatibility.
...
* Fix: Fixed the issue of validating the Min/Max length value for textarea field input while the default value is greater than Max value or lesser than Min value.
* Improvement: Added WooCommerce version - 5.3.0 compatibility.
* Improvement: Defined user capabilities to all form actions for improved security.
* Improvement: Improved admin alerts while HTML tag entered in the field label.

= 3.0.3 =
* Fix: Issue of redirection to a blank section while deleting a section.
* Fix: Fields not displayed while adding fields after settings reset using Reset to defaults button.
* Fix: Date picker field display issues(WordPress theme - Avada) for the variable product type.
* Improvement: Color picker display view in the order details page for the Color picker field type.
* Improvement: Display style of the Color picker field value in the resend new order notification for the Color picker field type.
* Improvement: Added Toggle password visibility for viewing the password field value on the product page.
* Improvement: Added WooCommerce version - 5.2.2 compatibility.
